...
module PDK
  module Template
    ...
    def self.with(uri, context)
      ...
      raise ArgumentError, '%{class_name}.with must be passed a PDK::Util::TemplateURI, got a %{uri_type}' % { uri_type: uri.class, class_name: name } unless uri.is_a? PDK::Util::TemplateURI

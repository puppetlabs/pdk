...
PDK's [default template](https://github.com/puppetlabs/pdk-templates) sets up [rspec](http://rspec.info/) for Ruby-level unit testing, and [puppetlabs-rspec](https://github.com/puppetlabs/puppetlabs-rspec/) for catalog-level unit testing.
